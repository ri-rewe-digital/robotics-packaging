class Parameters:
    def __init__(self, population_factor=30, elites_percentage=0.1, mutants_percentage=0.15,
                 inherit_elite_probability=0.7, max_generations=200, max_generations_no_improvement=5, number_of_threads=10):
    ...
    def __repr__(self):
        return "(population_factor=%r, elites_percentage=%r, mutants_percentage=%r, inherit_elite_probability=%r, max_generations=%r, max_generations_no_improvement=%r, number_of_threads=%r)" % (
...
class GAParameters():
    def __init__(self, population_size, num_elites, num_mutants, inherit_elite_probability, max_generations,
                 max_generations_no_improvement, number_of_threads):
        self.max_generations = max_generations
        self.inherit_elite_probability = inherit_elite_probability
        self.max_generations_no_improvement = max_generations_no_improvement
